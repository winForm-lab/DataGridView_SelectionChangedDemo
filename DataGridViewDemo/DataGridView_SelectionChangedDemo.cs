...
// https://msdn.microsoft.com/en-us/library/system.windows.forms.datagridview.selectionchanged(v=vs.110).aspx
public class DataGridView_SelectionChangedDemo : Form
{
    ...
    public DataGridView_SelectionChangedDemo()
    {
        // Initialize the form.
